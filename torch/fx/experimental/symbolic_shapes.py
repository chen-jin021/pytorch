...
class ShapeEnv:
    ...
    def __init__(
        ...
        *,
        ...
        # None: follow torch._dynamo.config.use_cpp_symnode and
        # use_cpp_fake_tensor. Config that the native env does not model
        ...
        **kwargs: Any,
        ...
        if _allow_native is None:
            ...
            _allow_native = (
                dynamo_config.use_cpp_symnode and dynamo_config.use_cpp_fake_tensor
            )
        if (
            _allow_native
